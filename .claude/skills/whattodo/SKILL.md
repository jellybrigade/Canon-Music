...
**"add [feature]":** Add a new row to the table. Ask for Type (Bugfix / QoL / Feature / Perf) and Priority (High / Medium / Low) if not provided. Also append a detail section at the bottom with what the user told you. Keep competitor-audit references if relevant.

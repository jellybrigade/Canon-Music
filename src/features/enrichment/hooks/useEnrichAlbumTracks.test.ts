...
vi.mock("../../../clients/lastfm", () => ({ fetchTrackTags: vi.fn() }));
vi.mock("../../tags/lib/tagNormalize", () => ({ normalizeAlbum: vi.fn().mockResolvedValue(undefined) }));
vi.mock("../../tags/lib/canonicalize", () => ({
...
import { fetchTrackTags } from "../../../clients/lastfm";

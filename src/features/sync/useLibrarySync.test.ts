...
vi.mock("./sync", () => ({ syncLibrary: vi.fn() }));
vi.mock("../tags/hooks/useGenreTree", () => ({ invalidateGenreTreeCache: vi.fn() }));
vi.mock("../../hooks/useSetting", () => ({ useSetting: vi.fn(() => [intervalSetting, vi.fn(), true]) }));

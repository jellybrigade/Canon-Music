...
// Window created hidden (tauri.conf.json); reveal only once the first paint has
// composited so the WebKitGTK freeze/thaw compositor race (known-issues.md) has less
// of a visible-but-settling window to land in on focus-loss/regain.
